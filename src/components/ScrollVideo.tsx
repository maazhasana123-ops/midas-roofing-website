...
const chapters = [
  {
    ...
    range: [0.0, 0.04, 0.12, 0.16] as const,
  },
  {
    number: '02',
    label: 'Teardown & Prep',
    ...
    range: [0.16, 0.20, 0.28, 0.32] as const,
  },
  {
    number: '03',
    label: 'Install & Seal',
    ...
    range: [0.32, 0.36, 0.44, 0.48] as const,
  },
  {
    number: '04',
    ...
    range: [0.48, 0.55, 1.0, 1.0] as const,
  },
]
...
export default function ScrollVideo() {
  ...
  const ch1Active = useTransform(scrollYProgress, [0.02, 0.06, 0.12, 0.16], [0.2, 1, 1, 0.2])
  const ch2Active = useTransform(scrollYProgress, [0.16, 0.20, 0.28, 0.32], [0.2, 1, 1, 0.2])
  const ch3Active = useTransform(scrollYProgress, [0.32, 0.36, 0.44, 0.48], [0.2, 1, 1, 0.2])
  const ch4Active = useTransform(scrollYProgress, [0.48, 0.55, 1.0, 1.0], [0.2, 1, 1, 1])
