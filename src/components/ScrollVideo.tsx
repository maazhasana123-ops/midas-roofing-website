...
const chapters = [
  {
    ...
    range: [0.0, 0.04, 0.20, 0.24] as const,
  },
  {
    number: '02',
    label: 'Teardown & Prep',
  ...
  },
  {
    ...
    range: [0.46, 0.50, 0.58, 0.62] as const,
  },
  {
    number: '04',
    ...
    range: [0.62, 0.70, 1.0, 1.0] as const,
  },
]
...
export default function ScrollVideo() {
  ...
  const ch4Active = useTransform(scrollYProgress, [0.64, 0.72, 1.0, 1.0], [0.2, 1, 1, 1])
